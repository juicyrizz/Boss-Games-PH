...
const AboutComponent = forwardRef<HTMLElement, AboutProps>(({ contactRef }, ref) => {
  return (
    <Section id="about" ref={ref} className="bg-transparent overflow-x-hidden">
        <div className="grid md:grid-cols-5 gap-12 items-center">
            <div className="md:col-span-2 flex items-center justify-center scroll-animate-left">
                <div className="relative w-full max-w-sm p-4 bg-gray-800/30 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="md:col-span-3 scroll-animate-right bg-gray-900/40 backdrop-blur-md border border-white/10 rounded-xl p-8 shadow-2xl" style={{ transitionDelay: '150ms' }}>
                ...
                <button onClick={() => scrollToSection(contactRef)} className="inline-block text-indigo-300 font-bold py-2 px-6 rounded-lg uppercase tracking-wider transition-all duration-300 bg-indigo-500/20 hover:bg-indigo-500/40 border-2 border-indigo-500/80 backdrop-blur-sm transform hover:scale-105">
                    Get in Touch
                </button>
            </div>
        </div>
